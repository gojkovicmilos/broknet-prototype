...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"field\">\n\n  <mat-card style=\"max-width: 500px; \">\n    <mat-card-header>\n      <mat-card-title>Sign in</mat-card-title>\n      <mat-card-subtitle>You can sign in with your email and password, or use Google</mat-card-subtitle>\n    </mat-card-header>\n    <mat-card-content>\n\n\n      <div class=\"authBlock\" style=\"padding-top: 1rem; padding-bottom: 1rem\">\n        <form class=\"example-form\">\n          <mat-form-field class=\"example-full-width\">\n            <input matInput placeholder=\"Username\" type=\"text\" #userName required>\n          </mat-form-field>\n\n          <mat-form-field class=\"example-full-width\">\n            <input matInput placeholder=\"Password\" type=\"password\" #userPassword required>\n          </mat-form-field>\n        </form>\n\n      </div>\n      <div class=\"box-1\">\n        <div class=\"btn btn-one\">\n          <span value=\"Log in\" (click)=\"authService.SignIn(userName.value, userPassword.value)\">Log In</span>\n        </div>\n      </div>\n\n      <!-- <div class=\"authBlock\" style=\"padding-top: 1rem; padding-bottom: 1rem\">\n          <div class=\"form-group\">\n            <input type=\"text\" class=\"formControl\" placeholder=\"Username\" #userName required>\n          </div>\n          \n          <div class=\"formGroup\" style=\"padding-top: 1rem; padding-bottom: 1rem\">\n            <input type=\"password\" class=\"formControl\" placeholder=\"Password\" #userPassword required>\n          </div>\n          <div class=\"formGroup\">\n            <button mat-raised-button color =\"accent\" type=\"button\" class=\"btn btnPrimary\" value=\"Log in\" (click)=\"authService.SignIn(userName.value, userPassword.value)\">Login</button>\n          </div>\n          </div> -->\n\n      <mat-grid-list cols=\"3\" rowHeight=\"2:1\">\n        <mat-grid-tile>\n          <button mat-raised-button color=\"accent\"  routerLink=\"/forgot-password\">Forgot Your\n            Password?</button>\n        </mat-grid-tile>\n        <mat-grid-tile>\n          <button mat-raised-button color=\"accent\"  routerLink=\"/register\">Sign Up</button>\n\n        </mat-grid-tile>\n        <mat-grid-tile>\n          <button mat-raised-button color=\"primary\"  type=\"button\" class=\"btn googleBtn\"\n          (click)=\"authService.GoogleAuth()\">\n          <i class=\"fab fa-google-plus-g\"></i>\n          Log In with Google\n        </button>\n\n        </mat-grid-tile>\n\n      </mat-grid-list>\n\n      <!-- <div class=\"pad\">\n        <button mat-raised-button color=\"accent\" style=\"margin-right: 10px;\" routerLink=\"/forgot-password\">Forgot Your\n          Password? </button>\n        <button mat-raised-button color=\"accent\" style=\"margin-right: 10px;\" routerLink=\"/register\">Sign Up</button>\n      </div> -->\n\n    </mat-card-content>\n    <mat-card-actions>\n      <!-- <div class=\"formGroup\">\n        <button mat-raised-button color=\"primary\" style=\"margin-right: 10px;\" type=\"button\" class=\"btn googleBtn\"\n          (click)=\"authService.GoogleAuth()\">\n          <i class=\"fab fa-google-plus-g\"></i>\n          Log in with Google\n        </button>\n      </div> -->\n\n    </mat-card-actions>\n  </mat-card>\n</div>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<mat-sidenav-container class=\"sidenav-container\">\n  <mat-sidenav #drawer class=\"sidenav\" fixedInViewport\n      [attr.role]=\"(isHandset$ | async) ? 'dialog' : 'navigation'\"\n      [mode]=\"(isHandset$ | async) ? 'over' : 'side'\"\n      [opened]=\"(isHandset$ | async) === false\">\n    <mat-toolbar style=\"background-color:#019281 ;\">Menu</mat-toolbar>\n    <mat-nav-list class=\"menuList\">\n      <a mat-list-item href=\"\">Home</a>\n      <a mat-list-item href=\"news\">News</a>\n      <a mat-list-item *ngIf=\"authService.isLoggedIn()\" href=\"user\">Your Portfolio</a>\n      <a mat-list-item *ngIf=\"!authService.isLoggedIn()\" href=\"login\">Log In</a>\n      <a mat-list-item *ngIf=\"!authService.isLoggedIn()\" href=\"register\">Register</a>\n      <a mat-list-item *ngIf=\"authService.isLoggedIn()\" (click)=\"authService.SignOut()\">Sign Out</a>\n      <a target='_blank' href=\"https://broknet-684ba.web.app/\" mat-list-item>BrokNet Chat</a>\n    </mat-nav-list>\n  </mat-sidenav>\n  <mat-sidenav-content>\n    <mat-toolbar color=\"primary\">\n      <button\n        type=\"button\"\n        aria-label=\"Toggle sidenav\"\n        mat-icon-button\n        (click)=\"drawer.toggle(); toggle()\"\n        >\n        <mat-icon style=\"font-size: 40px;\" aria-label=\"Side nav toggle icon\" *ngIf=\"!drawerClosed\">toggle_off</mat-icon>\n        <mat-icon style=\"font-size: 40px;\" aria-label=\"Side nav toggle icon\" *ngIf=\"drawerClosed\">toggle_on</mat-icon>\n      </button>\n      <span routerLink='' style=\"cursor: pointer; margin-left: 1rem\">BrokNet Prototype</span>\n      <div class=\"fill-space\"></div>\n      <button *ngIf='authService.isLoggedIn()' mat-icon-button routerLink='profile'><mat-icon style=\"font-size: 35px;\">account_circle</mat-icon></button>\n    </mat-toolbar>\n    <!-- Add Content Here -->\n    <div style=\"padding: 1rem\">\n        <router-outlet></router-outlet>\n    </div>\n  </mat-sidenav-content>\n</mat-sidenav-container>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h1>Welcome, {{userData.displayName}}!</h1>\n\n<hr>\n<h3>Portfolio: </h3>\n\n<div *ngFor='let p of portfolio'>\n    <p>ID: {{p.id}}</p>\n    <p>Amount: {{p.amount}}</p>\n    <hr class=\"test\">\n</div>\n\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n<!-- <button mat-button (click)=\"fillDb()\">Fill Firebase</button> -->\n\n<div class=\"newsDiv\">\n    <mat-card *ngFor=\"let article of sortedArticles\">\n        <mat-card-header>\n          <mat-card-title>{{article.title}}</mat-card-title>\n          <mat-card-subtitle>Written by: {{article.author}} at {{article.publishedAt}}</mat-card-subtitle>\n        </mat-card-header>\n        <img mat-card-image src=\"{{article.urlToImage}}\" >\n        <mat-card-content>\n          <p>{{article.description}}</p>\n        </mat-card-content>\n        <mat-card-actions>\n            <a mat-raised-button color=\"primary\" href=\"{{article.url}}\">Learn More</a>\n        </mat-card-actions>\n      </mat-card>\n</div>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"field\">\n  <mat-card style=\"padding-top: 1rem; padding-bottom: 1rem; max-width: 500px\">\n    <mat-card-header>\n      <mat-card-title>Welcome!</mat-card-title>\n      <mat-card-subtitle>Enter email and password to sign up, or sign up with Google</mat-card-subtitle>\n    </mat-card-header>\n    <mat-card-content>\n      <div class=\"authBlock\" style=\"padding-top: 1rem; padding-bottom: 1rem\">\n        <form class=\"example-form\">\n          <mat-form-field class=\"example-full-width\">\n            <input matInput placeholder=\"Email\" type=\"email\" #userEmail required>\n          </mat-form-field>\n          \n          <mat-form-field class=\"example-full-width\">\n            <input matInput placeholder=\"Password\" type=\"password\" #userPwd required>\n          </mat-form-field>\n        </form>\n      </div>\n\n      <div class=\"box-1\">\n        <div class=\"btn btn-one\">\n          <span value=\"Sign Up\" (click)=\"authService.SignUp(userEmail.value, userPwd.value)\">Sign up</span>\n        </div>\n      </div>\n\n\n\n    </mat-card-content>\n    <mat-card-actions>\n\n      <mat-grid-list cols=\"2\" rowHeight=\"2:1\" style=\"margin:10px;\">\n        <mat-grid-tile><button mat-raised-button color=\"primary\" (click)=\"authService.GoogleAuth()\">\n            Continue with Google\n          </button></mat-grid-tile>\n        <mat-grid-tile> <button mat-raised-button color=\"accent\" routerLink=\"/login\">Have an Account? Log In</button>\n        </mat-grid-tile>\n     </mat-grid-list>\n    </mat-card-actions>\n  </mat-card>\n</div>\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/test-page/test-page.component.html":
/*!******************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/test-page/test-page.component.html ***!
  \******************************************************************************************/
/*! exports provided: default */
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/verify-email-address/verify-email-address.component.html":
/*!****************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/verify-email-address/verify-email-address.component.html ***!
  \****************************************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _test_page_test_page_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./test-page/test-page.component */ "./src/app/test-page/test-page.component.ts");
...
/* harmony import */ var _verify_email_address_verify_email_address_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./verify-email-address/verify-email-address.component */ "./src/app/verify-email-address/verify-email-address.component.ts");
...
/* harmony import */ var _my_profile_my_profile_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./my-profile/my-profile.component */ "./src/app/my-profile/my-profile.component.ts");
...
const routes = [
    { path: "", component: _test_page_test_page_component__WEBPACK_IMPORTED_MODULE_4__["TestPageComponent"] },
    { path: "user", component: _home_page_home_page_component__WEBPACK_IMPORTED_MODULE_3__["HomePageComponent"] },
    ...
    { path: "verify-email-address", component: _verify_email_address_verify_email_address_component__WEBPACK_IMPORTED_MODULE_8__["VerifyEmailAddressComponent"] },
    ...
    { path: 'profile', component: _my_profile_my_profile_component__WEBPACK_IMPORTED_MODULE_10__["MyProfileComponent"] }
];
...
/* harmony import */ var _test_page_test_page_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./test-page/test-page.component */ "./src/app/test-page/test-page.component.ts");
...
/* harmony import */ var _news_news_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./news/news.component */ "./src/app/news/news.component.ts");
...
/* harmony import */ var _verify_email_address_verify_email_address_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./verify-email-address/verify-email-address.component */ "./src/app/verify-email-address/verify-email-address.component.ts");
/* harmony import */ var _my_profile_my_profile_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./my-profile/my-profile.component */ "./src/app/my-profile/my-profile.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _test_page_test_page_component__WEBPACK_IMPORTED_MODULE_10__["TestPageComponent"],
            ...
            _verify_email_address_verify_email_address_component__WEBPACK_IMPORTED_MODULE_24__["VerifyEmailAddressComponent"],
            _my_profile_my_profile_component__WEBPACK_IMPORTED_MODULE_25__["MyProfileComponent"]
        ],
        imports: [
...
/***/ "./src/app/financial-api.service.ts":
/*!******************************************!*\
  !*** ./src/app/financial-api.service.ts ***!
  \******************************************/
/*! exports provided: FinancialApiService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FinancialApiService", function() { return FinancialApiService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
FinancialApiService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
    { type: _firebase_service__WEBPACK_IMPORTED_MODULE_3__["FirebaseService"] }
];
FinancialApiService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], FinancialApiService);
...
let FirebaseService = class FirebaseService {
    ...
    updatePortfolio(userId, newPortfolio) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".buyBtn{\n    margin-left: 15px;\n    margin-right: 10px;\n    \n  }\n  .buyBtn:hover{\n      box-shadow: 0 0px 24px 0 #48a999;\n      -moz-box-shadow: 0 0px 24px 0 #48a999;\n      -webkit-box-shadow: 0 0px 24px 0 #48a999;   \n      color:green;\n  }\n  .sellBtn:hover{\n    box-shadow: 0 0px 24px 0 #48a999;\n    -moz-box-shadow: 0 0px 24px 0 #48a999;\n    -webkit-box-shadow: 0 0px 24px 0 #48a999;   \n    color:red;\n\n  }\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _assets_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../assets/canvasjs.min.js */ "./src/assets/canvasjs.min.js");
/* harmony import */ var _assets_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_assets_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_3__);
...
let HomePageComponent = class HomePageComponent {
    constructor(fbs, router, _snackBar) {
        this.fbs = fbs;
        this.router = router;
    ...
    ngOnInit() {
        ...
        this.fbs.getStocks().subscribe(actionArray => {
            ...
            this.user.portfolio.forEach(item => { if (item.amount == 0)
                this.user.portfolio.splice(this.user.portfolio.indexOf(item)); });
            let ids = this.user.portfolio.map(item => item.id);
            this.filteredStocks = this.stocks.filter(item => ids.includes(item.id));
            setTimeout(() => this.filteredStocks.forEach(element => {
    ...
    autoTrade(stock, min, max, maxInvestment, amount) {
    ...
    findInvestment(stock) {
        let investment = 0;
        this.user.portfolio.forEach(item => { if (item.id == stock.id)
    ...
    drawChart(i) {
        ...
        let chart = new _assets_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_3__["Chart"]("chartContainer" + i, {
            zoomEnabled: true,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("@import 'https://fonts.googleapis.com/css?family=Open+Sans+Condensed:300';\n.example-form {\n    min-width: 150px;\n    max-width: 500px;\n    width: 100%;\n  }\n.example-full-width {\n    width: 100%;\n  }\n.authBlock{\n      margin-bottom: 15px;\n  }\n.field{\n      margin-left: 30%;\n      margin-right: 30%;\n  }\nhtml,\n  body {\n    width: 100%;\n    height: 100%;\n    overflow: hidden;\n    margin: 0;\n    display: flex;\n    flex-direction: column;\n    flex-wrap: wrap;\n    font-family: 'Open Sans Condensed', sans-serif;\n  }\ndiv[class*=box] {\n      height: 33.33%;\n      width: 80%; \n    display: flex;\n    justify-content: center;\n    align-items: center;\n    margin-right: auto;\n    margin-left: auto;\n  }\n.box-1 {\n       background-color: #00796b; \n       width: 150px ;\n       margin: 10 px;\n       margin-left: auto;\n       margin-right: auto;\n       padding-top: 10px;\n       padding-bottom: 10px;\n       padding-left: 10px;\n       padding-right: 10px;\n       margin-bottom: 15px;\n    }\n.btn {\n      line-height: 50px;\n      height: 50px;\n      text-align: center;\n      width: 350px;\n      cursor: pointer;\n      margin-left: auto;\n      margin-right: auto;\n  }\n/* \n  ========================\n        BUTTON ONE\n  ========================\n  */\n.btn-one {\n      color: #FFF;\n      transition: all 0.3s;\n      position: relative;\n      margin-left: auto;\n      margin-right: auto;\n  }\n.btn-one span {\n      \n      transition: all 0.3s;\n  }\n.btn-one::before {\n      content: '';\n      position: absolute;\n      bottom: 0;\n      left: 0;\n      width: 100%;\n      height: 100%;\n      z-index: 1;\n      opacity: 0;\n      transition: all 0.3s;\n      border-top-width: 1px;\n      border-bottom-width: 1px;\n      border-top-style: solid;\n      border-bottom-style: solid;\n      border-top-color: rgba(255,255,255,0.5);\n      border-bottom-color: rgba(255,255,255,0.5);\n      transform: scale(0.1, 1);\n  }\n.btn-one:hover span {\n      letter-spacing: 2px;\n  }\n.btn-one:hover::before {\n      opacity: 1; \n      transform: scale(1, 1); \n  }\n.btn-one::after {\n      content: '';\n      position: absolute;\n      bottom: 0;\n      left: 0;\n      width: 100%;\n      height: 100%;\n      z-index: 1;\n      transition: all 0.3s;\n      background-color: rgba(255,255,255,0.1);\n  }\n.btn-one:hover::after {\n      opacity: 0; \n      transform: scale(0.1, 1);\n  }\n  \n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".sidenav-container {\n  height: 100%;\n}\n\n.sidenav {\n  width: 200px;\n}\n\na:hover{\n  box-shadow: 0 0px 12px 0 #48a999;\n    -moz-box-shadow: 0 0px 12px 0 #48a999;\n    -webkit-box-shadow: 0 0px 12px 0 #48a999;   \n    \n\n}\n\n.sidenav .mat-toolbar {\n  background: inherit;\n}\n\n.mat-toolbar.mat-primary {\n  position: -webkit-sticky;\n  position: sticky;\n  top: 0;\n  z-index: 1;\n}\n\n.fill-space {\n  flex: 1 1 auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".test{\n    width: 250px;\n    margin-left: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("mat-card {\n    margin-bottom: 1rem; \n    border: 1px solid #48a999; \n    box-shadow: 0 0px 8px 0 #48a999;\n    /* max-width: 600px;\n    max-height: 400px; */\n    margin-top: 40px;\n    margin-bottom: 40px;\n}\n\n\n.newsDiv{\n    padding-right: 2rem;\n     padding-left: 2rem;\n      margin-top: 30px;\n       margin-bottom: 30px;\n        max-width: 700px;\n         max-height: 400px;\n          margin-left:auto; \n          margin-right: auto;\n\n}\n\n\nmat-card:hover {\n    box-shadow: 0 0px 24px 0 #48a999;\n    -moz-box-shadow: 0 0px 24px 0 #48a999;\n    -webkit-box-shadow: 0 0px 24px 0 #48a999;   \n}\n\n\nmat-card:first-child {\n    margin-top: 10 rem;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
    ...
    ngOnInit() {
        this.fbs.getNews().subscribe(actionArray => {
            ...
            this.ns.getTopHeadlines().subscribe(res => {
                ...
                this.sortedArticles = this.articles.sort((a, b) => new Date(b.publishedAt).getTime() - new Date(a.publishedAt).getTime());
            });
        });
    }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("@import 'https://fonts.googleapis.com/css?family=Open+Sans+Condensed:300';\n.example-form {\n    min-width: 150px;\n    max-width: 500px;\n    width: 100%;\n  }\n.example-full-width {\n    width: 100%;\n  }\n.authBlock{\n      margin-bottom: 15px;\n      margin-top: 15px;\n      margin-left: auto;\n      margin-right: auto;\n      padding-right: 10px;\n      padding-left: 10px;\n      padding-bottom: 10px;\n      padding-top: 10px;\n  }\n.field{\n      margin-left: 30%;\n      margin-right: 30%;\n  }\nhtml,\n  body {\n    width: 100%;\n    height: 100%;\n    overflow: hidden;\n    margin: 0;\n    display: flex;\n    flex-direction: column;\n    flex-wrap: wrap;\n    font-family: 'Open Sans Condensed', sans-serif;\n  }\ndiv[class*=box] {\n      height: 33.33%;\n      width: 80%; \n    display: flex;\n    justify-content: center;\n    align-items: center;\n    margin-right: auto;\n    margin-left: auto;\n  }\n.box-1 {\n       background-color: #00796b; \n       width: 150px ;\n       margin: 10 px;\n       margin-left: auto;\n       margin-right: auto;\n       padding-top: 10px;\n       padding-bottom: 10px;\n       padding-left: 10px;\n       padding-right: 10px;\n       margin-bottom: 15px;\n    }\n.btn {\n      line-height: 50px;\n      height: 50px;\n      text-align: center;\n      width: 350px;\n      cursor: pointer;\n      margin-left: auto;\n      margin-right: auto;\n  }\n/* \n  ========================\n        BUTTON ONE\n  ========================\n  */\n.btn-one {\n      color: #FFF;\n      transition: all 0.3s;\n      position: relative;\n      margin-left: auto;\n      margin-right: auto;\n  }\n.btn-one span {\n      \n      transition: all 0.3s;\n  }\n.btn-one::before {\n      content: '';\n      position: absolute;\n      bottom: 0;\n      left: 0;\n      width: 100%;\n      height: 100%;\n      z-index: 1;\n      opacity: 0;\n      transition: all 0.3s;\n      border-top-width: 1px;\n      border-bottom-width: 1px;\n      border-top-style: solid;\n      border-bottom-style: solid;\n      border-top-color: rgba(255,255,255,0.5);\n      border-bottom-color: rgba(255,255,255,0.5);\n      transform: scale(0.1, 1);\n  }\n.btn-one:hover span {\n      letter-spacing: 2px;\n  }\n.btn-one:hover::before {\n      opacity: 1; \n      transform: scale(1, 1); \n  }\n.btn-one::after {\n      content: '';\n      position: absolute;\n      bottom: 0;\n      left: 0;\n      width: 100%;\n      height: 100%;\n      z-index: 1;\n      transition: all 0.3s;\n      background-color: rgba(255,255,255,0.1);\n  }\n.btn-one:hover::after {\n      opacity: 0; \n      transform: scale(0.1, 1);\n  }\n  \n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".buyBtn{\n  margin-left: 15px;\n  margin-right: 10px;\n  \n}\n.buyBtn:hover{\n    box-shadow: 0 0px 24px 0 #48a999;\n    -moz-box-shadow: 0 0px 24px 0 #48a999;\n    -webkit-box-shadow: 0 0px 24px 0 #48a999;   \n}\n\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _financial_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../financial-api.service */ "./src/app/financial-api.service.ts");
...
/* harmony import */ var _assets_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../assets/canvasjs.min.js */ "./src/assets/canvasjs.min.js");
/* harmony import */ var _assets_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_assets_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_5__);
...
let TestPageComponent = class TestPageComponent {
    ...
    sortStocks(parameter, ort) {
        if (parameter == "change_pct" && ort == "desc")
            this.stocks.sort((a, b) => b.change_pct - a.change_pct);
        else if (parameter == "change_pct" && ort == "asc")
            this.stocks.sort((a, b) => a.change_pct - b.change_pct);
        else if (parameter == "price" && ort == "asc")
            this.stocks.sort((a, b) => a.price - b.price);
        else if (parameter == "price" && ort == "desc")
            this.stocks.sort((a, b) => b.price - a.price);
        else if (parameter == "name" && ort == "desc")
            this.stocks.sort((a, b) => b.name - a.name);
        else if (parameter == "name" && ort == "asc")
    ...
    drawChart(i) {
        ...
        let chart = new _assets_canvasjs_min_js__WEBPACK_IMPORTED_MODULE_5__["Chart"]("chartContainer" + i, {
            zoomEnabled: true,
            animationEnabled: true,
            exportEnabled: true,
            theme: "dark1",
...
TestPageComponent.ctorParameters = () => [
    { type: _financial_api_service__WEBPACK_IMPORTED_MODULE_2__["FinancialApiService"] },
    { type: _news_api_service__WEBPACK_IMPORTED_MODULE_3__["NewsApiService"] },
...
TestPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./test-page.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/test-page/test-page.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./test-page.component.css */ "./src/app/test-page/test-page.component.css")).default]
    })
], TestPageComponent);
...
/***/ "./src/app/verify-email-address/verify-email-address.component.css":
/*!*************************************************************************!*\
  !*** ./src/app/verify-email-address/verify-email-address.component.css ***!
  \*************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3ZlcmlmeS1lbWFpbC1hZGRyZXNzL3ZlcmlmeS1lbWFpbC1hZGRyZXNzLmNvbXBvbmVudC5jc3MifQ== */");

/***/ }),

/***/ "./src/app/verify-email-address/verify-email-address.component.ts":
/*!************************************************************************!*\
  !*** ./src/app/verify-email-address/verify-email-address.component.ts ***!
  \************************************************************************/
...
VerifyEmailAddressComponent.ctorParameters = () => [
    { type: _auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] }
];
VerifyEmailAddressComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-verify-email-address',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./verify-email-address.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/verify-email-address/verify-email-address.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./verify-email-address.component.css */ "./src/app/verify-email-address/verify-email-address.component.css")).default]
    })
...
module.exports = __webpack_require__(/*! /home/gojkas/Documents/GitHub/broknet-prototype/src/main.ts */"./src/main.ts");
